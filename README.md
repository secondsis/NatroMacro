...
<a name="ai usage"><h2>🤖 AI Usage</h2></a>

For any project reviewers (unrelated to BSS): NO code from me (Sn0wd) was generated from AI 🚫❌👎👎👎. I will note <br>
though that I may sometimes ask AI to explain snippets of code, but all code committed by Sn0wd is <br>
generated by me (UNLESS I explicitly state in the commit msg that the commit is a update/fix/patch <br>
created by someone else but it won't be AI under my knowledge)
